...
// 🤖 Github Repository: https://fox/engine/fiber
...
func Test_Utils_FunctionName(t *testing.T) {
	t.Parallel()
	AssertEqual(t, "fox/engine/utils.Test_Utils_UUID", FunctionName(Test_Utils_UUID))

	AssertEqual(t, "fox/engine/utils.Test_Utils_FunctionName.func1", FunctionName(func() {}))
